...
// Script to add rating system to all products in home_kitchen2.html
document.addEventListener('DOMContentLoaded', function() {
    ...
    productCards.forEach(card => {
        ...
        const ratingHTML = `
            <!-- Rating System -->
            <div class="rating" data-product-id="home-kitchen-product-${productCounter}">
        ...
        // Find the product price div to insert rating before
